        ...
        <div class="col-md-6">
          ...
          form ================================================ --}}
            ...
            Laravel ================================================ --}} @csrf
              ...
              kembali nilai sebelumnya jika form gagal validasi --}} required autocomplete="email" autofocus placeholder="nama@email.com"> {{--
              Tampilkan pesan error jika ada --}} @error('email')
                ...
                disembunyikan
                (●●●●)
                --}} class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="current-password" placeholder="••••••••" />
